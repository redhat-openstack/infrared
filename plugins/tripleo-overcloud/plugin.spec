              ...
              options:
                  role-files:
                      ...
                      help: |
                        ...
                        For MultiRHEL roles:
                        Each MultiRHEL/RHEL8 role specified in this param has to be specified in multirhel-roles-map param as well.
              ...
              options:
                  ...
                  multirhel-roles-map:
                      ...
                      help: |
                        ...
                        NOTE: If a given MultiRHEL/RHEL8 role already exists in /usr/share/openstack-tripleo-heat-templates/roles then it should _not_ be included in this mapping.
                        NOTE2: When using composable roles each MultiRHEL role specified in this mapping has to be also included in 'role-files' parameter of this plugin.
