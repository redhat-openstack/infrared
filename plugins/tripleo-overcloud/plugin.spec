            ...
            - title: Overcloud storage
              options:
                  ...
                  manila-backends:
                      type: KeyValueList
                      help: |
                        The manila storage backends that we would like to use.
                        This parameter is of KeyValueList type, when the key specifies
                        the name/type of the manila backend and the value specifies
                        ...
                        Value example:
                        --manila-backends netapp:external,ceph:internal
