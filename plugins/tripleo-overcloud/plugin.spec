            ...
            - title: Overcloud Options
              options:
                  ...
                  fetchfiles-undercloud:
                      ...
                      action: append
                      help: |
                          List of two/three elements 'URL,destfile[,dont_use_root]'. File from 'URL' will be downloaded as 'destfile' (overwrite existing file) on Undercloud.
                          'destfile' is an absolute path on Undercloud ending _with_ file name (because sometimes it's required to change file name).
                          Optionally, a third element 'dont_use_root' can be specified; if this element is present, the 'destfile' is saved as a non root user; in other case, 'destfile' is saved as root user.
                          ...
                          Example (in case one wants to use files from https://review.openstack.org/#/c/585015/2):
                              ...
                              --fetchfiles-undercloud https://git.openstack.org/cgit/openstack/tripleo-heat-templates/plain/puppet/services/opendaylight-api.yaml?h=refs/changes/15/585015/2,/home/stack/opendaylight-api.yaml,true
