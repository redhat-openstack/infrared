              ...
              options:
                  ...
                  heat-params:
                      ...
                      help: |
                          ...
                          NOTE: Value of this parameter has to be in oneline Yaml format (with {}). Also singlequote (')
                          strings that contain colons which should be considered as string rather than dictionary marker.
                          Example:
