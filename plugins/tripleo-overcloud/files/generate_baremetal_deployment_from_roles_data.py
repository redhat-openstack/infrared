...
class BaremetalRoleData():
    ...
    def __init__(self, role_data: Dict, networks_data: Dict) -> None:
...
def convert_role_data(roles_data: Dict, networks_data: Dict,
    ...
    for role_data in roles_data:
        ...
        try:
            ...
            # either not available, or not an integer
            nc = None
        if nc is not None:
            role_obj.roles_count = nc
        if role_obj.roles_count > 0:
            all_roles.append(
