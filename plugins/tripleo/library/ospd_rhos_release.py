...
options:
    ...
    director_build_date:
        description:
            - For OSPD 7-9 director can have different repos
    target_directory:
        description:
...
- name: Uninstalls release
  ospd_rhos_release: state=uninstall
...
- name: Get director and core puddle versions
  ...
  # show versions:
  debug: msg={{ director_release_results.releases.director.version }}
...
def main():
    ...
    if state == 'uninstall':
        ...
        if release < 10 and director_puddle is not False:
