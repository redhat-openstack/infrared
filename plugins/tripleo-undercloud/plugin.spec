              ...
              options:
                  multirhel-enable:
                      ...
                      help: |
                        ...
                        and processes automatically unless overriden by below multirhel-* options.
                      default: false
                      ansible_variable: multirhel_enable
                      required_when: "multirhel-overcloud-image-urls != '' or multirhel-overcloud-container-prepare-parameter-file != '' or multirhel-overcloud-container-image-prepare-parameter-tag != ''"
                  ...
                  multirhel-overcloud-image-urls:
                      ...
                      help: |
                        ...
                        Example:
                          --multirhel-overcloud-image-urls http://.../Packages/rhosp-director-images-uefi-x86_64-17.1-20230125.1.test.el8ost.noarch.rpm,http://download.devel.redhat.com/rcm-guest.../os/Packages/rhosp-director-images-ipa-x86_64-17.1-20230125.1.test.el8ost.noarch.rpm
                  ...
                  multirhel-overcloud-container-image-prepare-parameter-file:
                      ...
                      help: |
                        ...
                        If not set and multirhel-enable parameter is set to true then the container image prepare parameter file will be generated automatically.
                        NOTE: This parameters is mutually exclusive with multirhel-overcloud-container-image-prepare-parameter-tag, e.g.: only either of these two params can be set.
                  ...
                  multirhel-overcloud-container-image-prepare-parameter-tag:
                      ...
                      help: |
                        ...
                        NOTE: The above example is a container image tag for (used by) OSP compose/puddle: RHOS-17.1-RHEL-8-20230214.n.1. Consult "container_image_prepare_parameter_defaults.yaml" file of a compose to find the container image tag used in it.
