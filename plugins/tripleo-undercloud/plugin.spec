            ...
            - title: MultiRHEL options
              options:
                  multirhel-enable:
                      ...
                      required_when: "multirhel-overcloud-image-urls != '' or multirhel-overcloud-container-prepare-parameter-file != ''"
                  ...
                  multirhel-overcloud-container-image-prepare-parameter-file:
                      type: Value
                      help: |
                        Path to container image prepare parameter yaml file that will be used for preparing/uploading of
                        container images for MultiRHEL/ComputeRHEL8 overcloud nodes. If not set and multirhel-enable parameters
                        is true then the container image prepare parameter file will be generated automatically.
