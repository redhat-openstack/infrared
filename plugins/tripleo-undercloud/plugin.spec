            ...
            - title: MultiRHEL options
              options:
                  ...
                  multirhel-overcloud-image-url:
                      ...
                      default: ''
                      help: |
                        Url to 'rhosp-director-images-x86_64' RPM which will be used for Compute RHEL8 nodes.
                        ...
                        Example:
                          --multirhel-overcloud-image-url http://.../Packages/rhosp-director-images_x86_64-17.1-20230125.1.test.el8ost.noarch.rpm
