            ...
            - title: Setup Undercloud Packages
              options:
                  ...
                  ceph-extra-version:
                      type: Value
                      help: |
                          Set up also the repositories for the requested ceph version, if supported by rhos-release (for example: 5.3, 6.0, 6.1).
            ...
            - title: Overcloud images
              options:
                  ...
                  images-url:
                      ...
                      required_when: "images-task == import" || "images-task == full_image"
