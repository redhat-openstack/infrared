...
class BeakerMachine(object):
    ...
    def _xml_rpc_auth(self):
        ...
        # To do it, ResponsiveSafeTransport is used instead of SafeTransport.
        class ResponsiveSafeTransport(xmlrpclib.SafeTransport):
        ...
        try:
            ...
            transport = ResponsiveSafeTransport(context=ssl_context)
        except TypeError:
            # py < 2.7.9
            transport = ResponsiveSafeTransport()
