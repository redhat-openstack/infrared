              ...
              options:
                  ...
                  virsh-snapshot-download-enable:
                      ...
                      help: |
                          ...
                          and the name specified by ``--virsh-snapshot-download-name``. The files
                          will be downloaded to ``--virsh-snapshot-path``. For this to work the
                          following environment variables must be set: OS_PROJECT_ID, OS_USERNAME,
                          OS_PASSWORD, OS_USER_DOMAIN_NAME, OS_AUTH_URL, OS_IDENTITY_API_VERSION.
                      default: False
                  virsh-snapshot-download-name:
                      type: Value
                      help: |
                          The name of the image set to be downloaded. This will be a folder object
                          in the container specified by ``--virsh-snapshot-container``.
                      required_when: virsh-snapshot-download-enable == yes
