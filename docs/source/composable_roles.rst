...
In order to deploy custom roles, the InfraRed should know what nodes should be used for what roles.
...
For the topology described above with the networker custom role the following role files can be defined:
  ...
  - <plugin_dir>/vars/role/**networker**/networker.yml - holds the networker role description with the neutron services
