...
Update:
    ...
    If the \"--skip_reqs\" flag is given, the requirements installation will be skipped::

        infrared plugin update [--skip_reqs] git-plugin
        infrared plugin update [--skip_reqs] git-plugin latest (same as the command above)
        infrared plugin update [--skip_reqs] git-plugin d77c1bh (will pull changes and checkout 'd77c1bh')
