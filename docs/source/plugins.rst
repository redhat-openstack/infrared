...
2. 'required_when' - Makes this argument required when the mentioned argument is given or has an exact mentioned value. (More than one condition is allowed with YAML list style)
