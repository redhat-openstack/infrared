...
For some more info about git review usage, read `Gerrit Intro`_ and `OpenStack Infra Manual`_.

.. _`review.gerrithub.io`: https://review.gerrithub.io/#/q/project:redhat-openstack/infrared
.. _`Gerrit Intro`: https://review.opendev.org/Documentation/intro-quick.html#_the_life_and_times_of_a_change
