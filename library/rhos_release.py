...
options:
    ...
    core_release:
        description:
            - the core release name to install. Will be installed after release
            if it is specified.
    core_build:
        description:
...
def main():
    ...
    puddle = module.params['build']
    # core params
    core_release = module.params['core_release']
    core_puddle = module.params['core_build']
    ...
    if state == 'uninstall':
        ...
        if not releases:
            module.fail_json(
                msg="'release' or 'core_release' option should be specified.")
