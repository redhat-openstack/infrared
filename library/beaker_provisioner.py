...
class BeakerMachine(object):
    ...
    def get_system_details(self):
        ...
        assert resp.status_code == SUCCESS_CODE, "Failed to get system's " \
                                                 "details"
    ...
    def _loan_system(self):
        ...
        assert resp.status_code == SUCCESS_CODE, "Failed to loan system"
    ...
    def _return_system(self):
        ...
        assert resp.status_code == SUCCESS_CODE, "Failed to return system"
    ...
    def _reserve_system(self):
        ...
        assert resp.status_code == SUCCESS_CODE, "Failed to reserve system"
    ...
    def _release_system(self):
        ...
        assert resp.status_code == SUCCESS_CODE, "Failed to release system"
