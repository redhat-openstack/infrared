...
class WorkspaceManagerSpec(api.SpecObject):
    ...
    def extend_cli(self, root_subparsers):
        ...
        checkout_parser.add_argument(
            "-c", "--create", action='store_true', dest="create_workspace",
    ...
    def spec_handler(self, parser, args):
        ...
        if subcommand == 'create':
            ...
            self._checkout_workspace(pargs.name, pargs.create_workspace)
    ...
    def _create_workspace(self, name):
        ...
        """
        print("Deprecated: create will only create the workspace and will "
              "no longer switch to it")
        self._checkout_workspace(name)

    def _checkout_workspace(self, name, create=True):
        """
        ...
        if create:
            print("Deprecated: checkout will not be creating workspace unless "
                  "-c or --create is also specified!")
