...
from ansible.module_utils._text import to_bytes, to_text #noqa
from ansible.plugins.callback import CallbackBase #noqa

try:
    from junit_xml import TestSuite, TestCase #noqa
...
class CallbackModule(CallbackBase):
    ...
    def _finish_task(self, status, result):
        ...
        if self._fail_on_change == 'true' and status == 'ok' and result._result.get(
                'changed', False):
            status = 'failed'
