        ...
        for command, command_dict in answer_file_args.items():
            for key in command_dict.keys():
                if key in deprecated_args:
                    deprecated_by = deprecated_args.get(key)
                    answer_file_args[command][deprecated_by] = \
                        answer_file_args[command][key]
                    del(answer_file_args[command][key])
                    warn_deprecated(command, key, deprecated_by)

        for command, command_dict in cli_args.items():
            for key in command_dict.keys():
                if key in deprecated_args:
                    deprecated_by = deprecated_args.get(key)
                    cli_args[command][deprecated_by] = \
                        cli_args[command][key]
                    del(cli_args[command][key])
                    warn_deprecated(command, key, deprecated_by)
