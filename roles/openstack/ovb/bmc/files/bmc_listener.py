...
# This script is copied from https://github.com/cybertron/openstack-virtual-baremetal/blob/master/bin/openstackbmc
# Ansible will launch it as a deamon for each of the overcloud nodes
