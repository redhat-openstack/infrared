...
# @pytest.fixture()
# def exec_from_basedir():
#     oldwd = os.getcwd()


@pytest.fixture(scope="module")
def cleantmp(request, tmpdir_factory):
    # def fin():
    #     tmpdir_factory.getbasetemp().remove()
    # request.addfinalizer(fin)
    request.addfinalizer(lambda: tmpdir_factory.getbasetemp().remove())


@pytest.fixture(scope="function")
def workspacedir(tmpdir_factory, cleantmp):
    workspace.WorkspaceManager.workspacedir = tmpdir_factory.mktemp(
        "workspaces").strpath
