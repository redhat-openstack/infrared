...
@pytest.mark.parametrize("test_key, override_param, override_value", [
    ("value-minmax", "minimum", "test_value_instead_of_number"),
    ("value-minmax", "maximum", "test_value_instead_of_number"),
    ("value-minmax", "minimum", True),
    ("value-minmax", "maximum", True),
    ("value-minmax", "minimum", "True"),
    ("value-minmax", "maximum", "True"),
    ("value-minmax", "maximum", ""),
    ("value-minmax", "minimum", ""),
    ("value-minmax", "minimum", None),
    ("value-minmax", "maximum", None),
