...
def test_profile_create(profile_manager, name):
    """
...
def test_profile_activate(profile_manager, test_profile):
    """
...
def test_profile_activate_negative(profile_manager):
    """
    Verify Profile manager allows to activate a profile.
    """
...
def test_profile_remove(profile_manager, test_profile):
    """
