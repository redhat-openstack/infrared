...
function help() {
    echo "$(basename "$0") -v [ -b ] [ -t ] -- script to generate release nodes between two git branches or commits"
    echo "where:"
    ...
    echo ""
    echo "Example: ./$(basename "$0") -v v3.0.0 -b stable master -f NEWFEATURE,APICHANGE"
